...
<body>
   ...
   <form action="action3.php" method="POST" id="coach"> 
      <div class="form-style-10">
   <h1>Designer un Coach 
  ...
  <br>
      ...
      <div class="inner-wrap">
     <label>Equipe a coacher:<br>
       <input type="text" name="nomE" required></label>
    <br>
     
     <label>Coach a choisir:<br>
       <input type="text" name="logim" required></label>
     </div>
     <br><br>
       <input type="submit" value="Designer Coach">
   </form> 
  </body>
</html>